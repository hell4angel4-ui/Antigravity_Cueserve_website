...
export default function AboutSection({ isAboutPage = false }: AboutSectionProps) {
  return (
    <section className="section about-us">
        ...
        <div className="about-us-title-wrapper">
          <div className="about-us-title-flex">
            ...
            >
              ...
              {isAboutPage && (
                <div className="mission-vision-wrap" style={{ marginTop: '2.5rem' }}>
                  <div className="our-mission-wrap" style={{ marginBottom: '1.5rem' }}>
                    <h2 className="our-mission-title" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem', color: '#0e1422' }}>Our Mission</h2>
                    <p className="our-mission-details" style={{ color: '#525b68', fontSize: '1rem', lineHeight: '1.6' }}>
                  ...
                  <div className="our-mission-wrap">
                    <h2 className="our-mission-title" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem', color: '#0e1422' }}>Our Vision</h2>
                    <p className="our-mission-details" style={{ color: '#525b68', fontSize: '1rem', lineHeight: '1.6' }}>
      ...
      {/* Stats and Video Card Container */}
              ...
              <div className="about-stats-counters-flex">
                <div className="single-testimonial-stat-wrap about-us">
                  <div className="testimonial-counter-wrap about-us">
                    <h2 className="single-number about-us" style={{ fontSize: '3rem', fontWeight: 800, color: '#0e1422', margin: 0, lineHeight: 1 }}>99%</h2>
                  </div>
                  <div className="testimonial-stat-text">Clients Satisfied and Repeating</div>
                </div>
                <div className="single-testimonial-stat-wrap about-us">
                  <div className="testimonial-counter-wrap about-us">
                    <h2 className="single-number about-us" style={{ fontSize: '3rem', fontWeight: 800, color: '#0e1422', margin: 0, lineHeight: 1 }}>150+</h2>
                  </div>
